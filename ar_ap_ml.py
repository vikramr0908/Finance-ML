...
Outputs:
  ...
  - kpi_summary.csv       : KPI table by client, month, aging bucket
...
df.to_csv("/Users/vikramramanathan/Downloads/Finance AR:AP/ar_ap_data.csv", index=False)
...
MODEL_DIR = "/Users/vikramramanathan/Downloads/Finance AR:AP/models"
...
df.to_csv("/Users/vikramramanathan/Downloads/Finance AR:AP/ar_ap_predictions.csv", index=False)
kpi_client.to_csv("/Users/vikramramanathan/Downloads/Finance AR:AP/kpi_by_client.csv", index=False)
kpi_month.to_csv("/Users/vikramramanathan/Downloads/Finance AR:AP/kpi_by_month.csv", index=False)
kpi_aging.to_csv("/Users/vikramramanathan/Downloads/Finance AR:AP/kpi_by_aging.csv", index=False)
kpi_resource.to_csv("/Users/vikramramanathan/Downloads/Finance AR:AP/kpi_by_resource.csv", index=False)

with open("/Users/vikramramanathan/Downloads/Finance AR:AP/model_metrics.txt", "w") as f:
    f.write("\n".join(metrics_lines))

with open("/Users/vikramramanathan/Downloads/Finance AR:AP/overall_kpis.json", "w") as f:
